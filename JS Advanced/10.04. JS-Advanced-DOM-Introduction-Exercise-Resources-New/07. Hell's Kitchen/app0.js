function onClick(input) {
    let input_jsarr = JSON.parse(input)
    let best_restaurant;
    let best_avg_sal = -10000.00;
    let restaurants_obj = {}

    //"PizzaHut - Peter 500, George 300, Mark 800" =  el
    ...
    document.getElementById('bestRestaurant').getElementsByTagName('p')[0].textContent = `Name: ${best_restaurant.name} Average Salary: ${best_restaurant.best_avg_sal.toFixed(2)} Best Salary: ${best_restaurant.best_salary.toFixed(2)}`;
...
onClick('["Mikes - Steve 1000, Ivan 200, Paul 800","Fleet - Maria 850, Janet 650","Mikes - Mirai 1200, Mimi 600"]')